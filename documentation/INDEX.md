...
2. [Getting started](./getting-started.md)
    1. [Install dependencies](./getting-started.md#install-dependencies)
    2. [Enable Sentry/Raven.js](./getting-started.md#enable-sentryravenjs)
    3. [Continuous integration and deployment](./getting-started.md#continuous-integration-and-deployment)
    4. [Enable greenkeeper](./getting-started.md#enable-greenkeeper)
