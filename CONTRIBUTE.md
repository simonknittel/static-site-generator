...
---
1. Run `npm install` and `jspm install` to install all dependencies.
1. Run `gulp watch` to build the site. It will automatically open a browser tab which will reload every time you change a source file.
