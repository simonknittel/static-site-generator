...
1. Create a new project on Sentry and add your public DSN to [scripts.js](./source/assets/scripts/scripts.js)
1. Uncomment Raven.js on [base.jade](./source/_partials/base.jade)
1. Run `npm install`
1. Run `jspm install`
1. Run `gulp watch`
